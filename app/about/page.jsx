...
export default function Page() {
  const skills = ["JavaScript", "React", "Next.js", "Python", "Flask", "SQL", "SQLite", "SQLAlchemy", "HTML", "CSS", "Git", "GitHub", "RESTful APIs", "Miro", "Figma", "Chart.js", "Beautiful Soup", "Material UI", "Semantic UI", "Tailwind CSS"]
  ...
  const skillsDisplay = skills.map(skill => <li key={skill} className="text-sm tracking-tight text-captions sm:text-base text-left mt-3">{skill}</li>)
      ...
      <div className="flex gap-8">
        <div>
          ...
          <p className="text-sm tracking-tight text-captions sm:text-base text-left mt-3">
            ...
            Laude to caring for our country&apos;s most critical patients, I have
            never met a challenge that I haven&apos;t fully embraced and
        ...
        <Image
          className="rounded shadow shadow-color-[#4c5657] float-right"
          src="/about_me.png"
          width={450}
          height={562}
